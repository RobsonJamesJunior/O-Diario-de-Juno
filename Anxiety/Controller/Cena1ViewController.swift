...
class Cena1ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let Cena1Gif = UIImage.gifImageWithName("Cena1") // Cria uma variável com a imagem Gif através da extensão da biblioteca ImageView que será utilizada na ImageView da Cena1
